...
<body>
    ...
    <div class="row">
        ...
        <h3>↑您的信息↑(请不要让任何人清楚上面的信息!内容仅用于浩瀚银河的管理和可溯源上传人员)↓输出信息↓(如果上传失败那么信息无效)</h3>
            ...
            <div class="column">
                <h2>视频走廊、分享功能:(costumer)</h2>
                <?php
                    $_InternatFILES = $_FILES["file"]["name"];
                    echo "Url: ";
                    echo "<p id=\"share-out\">https://fsvideo.haohanyh.com/files.php?upload#$_InternatFILES</p>";
                    echo "QQShare Url: ";
                    echo "<p id=\"QQShare-out\">http://connect.qq.com/widget/shareqq/index.html?url=". "https://fsvideo.haohanyh.com/files.php?upload#$_InternatFILES" . "</p>";
                    $qqoutlink = "http://connect.qq.com/widget/shareqq/index.html?url=". "https://fsvideo.haohanyh.com/files.php?upload#$_InternatFILES";
    ...
    <div class="topnav">
        <button class="button button2" onclick="myFunction1()">外网地址</button>
        <button class="button button2" onclick="myFunction2()">Markdown复制</button>
...
<footer class="footer">
    ...
    <p>| 视频一经上传，视为认同审阅视频和遵守中国大陆和中国港澳台地区相关法律，禁止将浩瀚银河开源产品用于含诈骗、赌博、色情、木马、病毒等违法违规业务。一旦发现违规，下架视频源文件+封禁IP+联络网络警察报警（12377国内举报平台、香港999报警、澳门和台湾110报警（涉嫌危害香港澳门的视频内容）） |</p>
</footer>
