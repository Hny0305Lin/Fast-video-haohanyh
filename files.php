...
class config {
  ...
  public static $default = array(
    ...
    'load_images_max_filesize' => 20000000, // maximum file size (bytes) for un-resized images loaded into list
    'load_svg_max_filesize' => 20000000, // 100k
    ...
    'files_exclude' => '/.(htaccess|xml|ini)$/i', // '/.(pdf|jpe?g)$/i'
    'dirs_exclude' => '/\/.well-known|\/_abc(\/|$)/i', //Convert|/football|/node_modules(/|$)/i',
    'allow_symlinks' => true, // allow symlinks
    // various
    'history' => true,
    'breadcrumbs' => true,
    ...
    'prevent_right_click' => true, // blocks browser right-click menu on sensitive items (images, list items, menu)
    'license_key' => ''
  );
  ...
  <body class="body-loading">
    <main id="main">
      ...
      <nav id="topbar"<?php if(!empty($topbar_classes)) echo ' class="' . join(' ', $topbar_classes) . '"'; ?>>
        <div id="topbar-top">
          <input id="search" type="点我搜索短视频哦" placeholder="点我搜索短视频哦" title="search" disabled>
...
var CodeMirror = {};
    ...
    <script src="/Anti-cheat Javascript/no-F12.js"></script>
    <script src="/Anti-cheat Javascript/no-Contextmenu.js"></script>
    <!--script src="/Anti-cheat Javascript/no-Developer.js"></script-->
    <!--防作弊插件--请不要恶意使用开发者工具和右击-->
    <script src=""></script>
    <!--script src="/Anti-cheat Javascript/no-Ctrl+Shift.js"></script-->
  </body>
</html>
<?php }}
// htmlend
